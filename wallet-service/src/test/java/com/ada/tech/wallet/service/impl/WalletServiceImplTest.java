package com.ada.tech.wallet.service.impl;
...
import com.ada.tech.wallet.model.Transaction;
...
import com.ada.tech.wallet.repository.TransactionRepository;
import com.ada.tech.wallet.repository.WalletRepository;
...
class WalletServiceImplTest {
    ...
    void deposit_Success() {
        ...
        Assertions.assertEquals(TransactionStatus.COMPLETED, response.getStatus());
        verify(walletRepository).findById(walletId);
        verify(walletRepository).save(any(Wallet.class));
    ...
    void withdraw_Success() {
        ...
        Assertions.assertEquals(TransactionType.WITHDRAWAL, response.getType());
        assertEquals(BigDecimal.valueOf(500), response.getAmount());
        Assertions.assertEquals(TransactionStatus.COMPLETED, response.getStatus());
        verify(walletRepository).findById(walletId);
        verify(walletRepository).save(any(Wallet.class));
    ...
    void transfer_Success() {
        ...
        Assertions.assertEquals(TransactionType.TRANSFER_OUT, responses.get(0).getType());
        Assertions.assertEquals(TransactionType.TRANSFER_IN, responses.get(1).getType());
